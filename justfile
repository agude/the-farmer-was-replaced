...
# Run the CPython achievement maze layout harness.
...
# Run the CPython reusable achievement maze harness.
achievement-maze-reuse-test:
    uv run scripts/test_achievement_maze_reuse.py

# Run the static Recycling achievement harness.
achievement-recycling-test:
    uv run scripts/test_achievement_recycling.py

# Run the CPython parallel achievement maze worker harness.
achievement-maze-workers-test:
    uv run scripts/test_achievement_maze_workers.py

# Run the static Maze Master runner harness.
...
# Run the CPython reset progression controller harness.
reset-progression-test:
    uv run scripts/test_reset_progression.py

# Run the CPython reset-safe farmer harness.
reset-farmers-test:
    uv run scripts/test_reset_farmers.py

# Run the static Fastest Reset submitted-window harness.
reset-entry-test:
    uv run scripts/test_reset_entry.py

# Run final implementation import and entry-point regression checks.
final-regression-test:
    uv run scripts/test_final_regression.py
...
# Run the static Carrot Master runner harness.
achievement-carrot-runner-test:
    uv run scripts/test_achievement_carrot_runner.py
...
check: lint cactus-test farm-layout-test sunflower-test dinosaur-test regular-farming-test fertilizing-test parallel-farming-test traversal-test planting-test hay-test carrot-test tree-test pumpkin-test cactus-cycle-test sunflower-cycle-test resource-cost-test top-hat-test top-hat-entry-test achievement-config-test achievement-metrics-test achievement-healer-test achievement-import-test achievement-stack-overflow-test achievement-cactus-test achievement-cactus-runner-test achievement-pumpkin-test achievement-pumpkin-runner-test achievement-hay-runner-test achievement-carrot-runner-test achievement-maze-test achievement-maze-mapping-test achievement-maze-reuse-test achievement-recycling-test achievement-maze-workers-test achievement-maze-runner-test leaderboard-cactus-test reset-simulation-test reset-progression-test reset-farmers-test reset-entry-test final-regression-test achievement-dinosaur-test achievement-polyculture-test achievement-polyculture-transaction-test achievement-polyculture-workers-test runner-test
