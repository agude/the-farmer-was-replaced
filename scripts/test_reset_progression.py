...
def test_default_plan_contains_explicit_target_levels() -> None:
    ...
    expected = {
        ...
        Unlocks.Watering: [1, 2, 3, 4, 5, 6],
        Unlocks.Pumpkins: [1, 2, 3, 4, 5],
        Unlocks.Sunflowers: [1],
        Unlocks.Polyculture: [1, 2],
    ...
    actual_route = [
        ...
        for unlock_target, target_level, _reason, _prerequisites in plan
    ]
    if actual_route != expected_route:
        raise AssertionError(f"reset route changed: {actual_route}")
